...
(Source for this image is available at [https://github.com/khulnasoft/docker-postgres-upgrade](https://github.com/khulnasoft/docker-postgres-upgrade).)
...
$ docker run --rm \
	...
	khulnasoft/postgres-upgrade:OLD-to-NEW \
	--link
...
$ docker run --rm \
	...
	khulnasoft/postgres-upgrade:9.4-to-9.5 \
	--link
